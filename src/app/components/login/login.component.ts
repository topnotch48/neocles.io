...
import { State, Authenticate, getAuthState, isAuthRequestInProgress } from "../../state";
...
export class LoginComponent implements OnInit {
    ...
    constructor(private store: Store<State>, private config: AppConfiguration, private fb: FormBuilder) {
    ...
    ngOnInit(): void {
        ...
        const usernameCtrl = this.fb.control('', [
            ...defaultValidators,
            Validators.email,
